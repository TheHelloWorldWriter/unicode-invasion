...
var unrenderableWidth = document.getElementById("not-renderable").offsetWidth;
console.log(unrenderableWidth);

var main = document.querySelector("main");

var charToCheck = document.getElementById("char-to-check");
...
function doesSupportEmoji(emoji) {
    console.log(context.measureText(emoji));

    context.fillText(emoji, 0, 0);
    // let imageData = context.getImageData(16, 16, 1, 1).data;
    return context.getImageData(16, 16, 1, 1).data[0] !== 0;
}

function printNew() {
    // let randomRange = UNICODE_RANGES[getRandomInt(0, UNICODE_RANGES.length)];
    // let randomCodePoint = getRandomInt(randomRange[0], randomRange[1]);
    // let emoji = String.fromCodePoint(randomCodePoint);
    // charToCheck.innerText = emoji;
    
    // // doesSupportEmoji(emoji);
    // // document.body.innerText += emoji + context.measureText(emoji).width + "\r\n";
    // // document.body.innerText += emoji + " " + charToCheck.innerText + " " + charToCheck.offsetWidth + "\r\n";
    // if (charToCheck.offsetWidth != unrenderableWidth) {
    //     // main.innerText += emoji + " " + charToCheck.innerText + " " + charToCheck.offsetWidth + "\r\n";
    //     main.innerText += emoji;
    // }
    ...
    //     let emoji = String.fromCodePoint(randomCodePoint);
    //     if (doesSupportEmoji(emoji)) {
    //         document.body.innerText += emoji;
